...
export class KdevInnerScrollDirective implements OnInit, OnDestroy
{
    // Private
    private _parent: any;
     ...
     * @param {KdevMatchMediaService} _kdevMediaMatchService
     * @param {Renderer2} _renderer
     */
    constructor(
        private _elementRef: ElementRef,
        private _kdevMediaMatchService: KdevMatchMediaService,
    ...
    ngOnInit(): void
    {
        ...
        this._kdevMediaMatchService.onMediaChange
