...
@Component({
    selector     : 'kdev-theme-options',
    templateUrl  : './theme-options.component.html',
    styleUrls    : ['./theme-options.component.scss'],
    encapsulation: ViewEncapsulation.None,
    animations   : kdevAnimations
})
export class KdevThemeOptionsComponent implements OnInit, OnDestroy
{
    kdevConfig: any;
    form: FormGroup;
    ...
    ngOnInit(): void
    {
        ...
        this.form.valueChanges
            ...
            .subscribe((config) => {
                ...
                // Update the config
                this._kdevConfigService.config = config;
            });
        ...
        this._kdevNavigationService.addNavigationItem(customFunctionNavItem, 'end');
    }
    ...
    ngOnDestroy(): void
    {
        ...
        this._kdevNavigationService.removeNavigationItem('custom-function');
    }
