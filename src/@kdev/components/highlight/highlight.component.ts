...
import '@kdev/components/highlight/prism-languages';

@Component({
    selector: 'kdev-highlight',
    template: '',
    styleUrls: ['./highlight.component.scss']
})
export class KdevHighlightComponent implements OnInit, OnDestroy {
    // Source
    @ContentChild('source')
    source: ElementRef;
    ...
    highlight(sourceCode): void {
        ...
        // can be formatted properly while using kdev-highlight
        // component
