...
import { KdevSidebarService } from './sidebar.service';
...
@Component({
    selector     : 'kdev-sidebar',
    templateUrl  : './sidebar.component.html',
    styleUrls    : ['./sidebar.component.scss'],
    encapsulation: ViewEncapsulation.None
})
export class KdevSidebarComponent implements OnInit, OnDestroy
{
    // Name
    @Input()
    name: string;
    ...
    ngOnInit(): void
    {
        ...
        this._kdevConfigService.config
            ...
            .subscribe((config) => {
                this._kdevConfig = config;
            });

        // Register the sidebar
        this._kdevSidebarService.register(this.name, this);
    ...
    ngOnDestroy(): void
    {
        ...
        this._kdevSidebarService.unregister(this.name);
    ...
    private _showBackdrop(): void
    {
        ...
        this._backdrop.classList.add('kdev-sidebar-overlay');

        // Add a class depending on the invisibleOverlay option
        if ( this.invisibleOverlay )
        {
            this._backdrop.classList.add('kdev-sidebar-overlay-invisible');
        }
