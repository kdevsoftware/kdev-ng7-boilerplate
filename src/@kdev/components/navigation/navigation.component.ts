...
@Component({
    selector       : 'kdev-navigation',
    templateUrl    : './navigation.component.html',
    styleUrls      : ['./navigation.component.scss'],
    encapsulation  : ViewEncapsulation.None,
    changeDetection: ChangeDetectionStrategy.OnPush
})
export class KdevNavigationComponent implements OnInit
{
    @Input()
    layout = 'vertical';
    ...
    ngOnInit(): void
    {
        ...
        this.navigation = this.navigation || this._kdevNavigationService.getCurrentNavigation();
