...
import { MatColors } from '@kdev/mat-colors';
import { ControlValueAccessor, NG_VALUE_ACCESSOR } from '@angular/forms';

export const KDEV_MATERIAL_COLOR_PICKER_VALUE_ACCESSOR: any = {
    provide    : NG_VALUE_ACCESSOR,
    useExisting: forwardRef(() => KdevMaterialColorPickerComponent),
    multi      : true
};

@Component({
    selector     : 'kdev-material-color-picker',
    templateUrl  : './material-color-picker.component.html',
    styleUrls    : ['./material-color-picker.component.scss'],
    animations   : kdevAnimations,
    encapsulation: ViewEncapsulation.None,
    providers    : [KDEV_MATERIAL_COLOR_PICKER_VALUE_ACCESSOR]
})
export class KdevMaterialColorPickerComponent implements ControlValueAccessor
{
    colors: any;
    hues: string[];
    view: string;
    ...
    set color(value)
    {
        ...
        // Split the color value (red-400, blue-500, kdev-navy-700 etc.)
